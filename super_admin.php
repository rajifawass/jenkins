            ...
            <?php foreach ($reservations as $reservation): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="edit_reservation.php?id=<?php echo $reservation['id']; ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> Modifier</a>
                        <a href="delete_reservation.php?id=<?php echo $reservation['id']; ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette réservation?');">Supprimer</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
