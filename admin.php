          ...
          <li class="nav-item me-3">
            <form method="post" action="">
              ...
              <button type="submit" class="nav-link"
                style="background:none; border:none; color:white; cursor:pointer;">Déconnexion <i class="fa fa-user"
    ...
    <div class="row">
      <?php foreach ($coiffeurs as $coiffeur): ?>
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="<?php echo $coiffeur['photo']; ?>" class="card-img-top" alt="<?php echo $coiffeur['nom']; ?>"
